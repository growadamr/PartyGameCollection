...
- **Drawing tools**: 5 colors (black/red/blue/green/yellow), undo, clear
...
4. **Show wrong guesses** - Display failed guesses to all players (adds humor and helps everyone)

### Medium Effort

5. **Variable brush size** - Add a thickness slider or 3 preset sizes
6. **Eraser tool** - Draw in white/background color
