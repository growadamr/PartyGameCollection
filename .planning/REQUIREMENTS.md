...
- [ ] **SETUP-01**: Host can select Imposter game from game selection menu
- [ ] **SETUP-02**: System assigns imposter count based on player count (1 for 4-5 players, 2 for 6-8 players)
- [ ] **SETUP-03**: Non-imposters see the secret word, imposters see "IMPOSTER"
- [ ] **SETUP-04**: Word selected randomly from compiled word list

### Discussion Phase

- [ ] **DISC-01**: Players see their role assignment (word or "IMPOSTER") on their device
- [ ] **DISC-02**: Free-form discussion phase - no turn structure enforced by game (players talk in person)
...
- [ ] **DATA-01**: Compile word list from existing charades/quick draw prompts into new file
- [ ] **DATA-02**: Original prompt files remain unmodified

### Integration

- [ ] **INT-01**: Godot game controller at `scripts/games/imposter.gd`
- [ ] **INT-02**: Godot game scene at `scenes/games/imposter/imposter.tscn`
- [ ] **INT-03**: Web player handler at `web-player/js/games/imposter.js`
- [ ] **INT-04**: Web player screen added to `web-player/index.html`
